...
public class MyJavaRulesDefinitionTest {
    ...
    @Test
    public void test() {
        RaindropJavaRulesDefinition rulesDefinition = new RaindropJavaRulesDefinition();
        RulesDefinition.Context context = new RulesDefinition.Context();
        rulesDefinition.define(context);
        RulesDefinition.Repository repository = context.repository(RaindropJavaRulesDefinition.REPOSITORY_KEY);
