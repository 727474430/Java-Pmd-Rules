 ...
 */
public class RaindropJavaRulesDefinition implements RulesDefinition {
    ...
    private void addMetadata(NewRule rule, String metadataKey) {
        URL resource = RaindropJavaRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.json");
        if (resource != null) {
    ...
    private static void addHtmlDescription(NewRule rule, String metadataKey) {
        URL resource = RaindropJavaRulesDefinition.class.getResource(RESOURCE_BASE_PATH + "/" + metadataKey + "_java.html");
        if (resource != null) {
